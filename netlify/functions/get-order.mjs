...
export async function handler(event) {
    ...
    if (isDemoMode()) {
        return jsonResponse(404, { error: 'Order not found. Demo orders are stored in your browser only.' }, headers);
    }
    ...
    try {
        ...
        return jsonResponse(500, { error: 'Could not fetch order' }, headers);
    }
}
